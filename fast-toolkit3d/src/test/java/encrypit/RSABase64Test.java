...
public class RSABase64Test {
    ...
    public static void main(String[] args) {
        ...
        // 进行公钥加密
        String base64Cipher = RSAWithBase64.encrypt(text, rsaKeyString.getPublicKey());

        // 得到加密后的密文
        System.out.println("加密后的base64密文：" + base64Cipher);
        System.out.println("解密加密的内容：" + RSAWithBase64.decrypt(base64Cipher, rsaKeyString.getPrivateKey()));


        base64Cipher = RSAWithBase64.sign(text, rsaKeyString.getPrivateKey());
        System.out.println("加签base64签文：" + base64Cipher);
        System.out.println("验签：" + RSAWithBase64.verify(text, base64Cipher, rsaKeyString.getPublicKey()));
